  ...
  return (
    <div id="wd-assignments-editor" className="container p-4">
      <Card className="shadow-sm">
        <Card.Body>
          <h3 className="mb-4">{isFacultyOrAdmin ? 'Edit Assignment' : 'Assignment Details'}</h3>
          <Form>
            <Row className="mb-3">
              <Col md={8}>
            ...
            <Row className="mb-3">
              <Col md={3}>
                ...
                <Form.Control 
                  ...
                  type="number" 
                  value={form.points ?? 0} 
                  onChange={(e) => setForm({ ...form, points: Number((e.target as HTMLInputElement).value) })}
                  disabled={!isFacultyOrAdmin}
                />
              </Col>
              <Col md={3}>
            ...
            {!isFacultyOrAdmin && (
              <Row className="mb-3">
                <Col>
                  <Button variant="secondary" onClick={cancel}>Back to Assignments</Button>
                </Col>
              </Row>
            )}
          </Form>
