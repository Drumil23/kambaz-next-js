export default function Positions() {
    return (
        <div id="wd-css-position-absolute">
            ...
            <h5>Note: The position examples are commented out to avoid overlapping elements on the page.</h5>
    ...
    wd-fg-color-white">
                ...
                <h5>Note: The fixed position example is commented out to avoid overlapping elements on the page.</h5>
            </div>
