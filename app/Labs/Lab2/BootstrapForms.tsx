import { FormControl, FormLabel, FormSelect, FormCheck, InputGroup, Row, Col } from "react-bootstrap";
    ...
    return (
        <div>
            <div id="wd-css-styling-forms">
                ...
                <FormControl type="email" placeholder="kotecha.d@northeastern.edu" />
            ...
            <div id="wd-css-styling-addons">
                ...
                <div id="wd-css-responsive-forms-1">
                    ...
                    <form>
                        <Row className="mb-3">
                            <FormLabel column sm={2} htmlFor="email1"> Email </FormLabel>
                            <Col sm={10}>
                                <FormControl id="email1" type="email" defaultValue="Enter your NU email id" />
                            </Col>
                        </Row>
                        <Row className="mb-3">
                            <FormLabel column sm={2} htmlFor="password1"> Password </FormLabel>
                            <Col sm={10}>
                        ...
                        <Col> <button type="submit" className="btn btn-primary">Sign in</button> </Col>
                    </form>
                </div>
            </div>
        </div>
